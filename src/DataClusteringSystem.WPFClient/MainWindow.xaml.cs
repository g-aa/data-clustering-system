...
using DataClusteringSystem.ClientLogic;
using DataClusteringSystem.ClientLogic.Handlers;
...
using DataClusteringSystem.WPFClient.Windows;

namespace DataClusteringSystem.WPFClient
{
    /// <summary>
